package school.prog.hellohei.endpoint.event.consumer;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("school.prog.hellohei.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "school.prog.hellohei.service.event."
