...
import static school.prog.hellohei.endpoint.event.EventStack.EVENT_STACK_1;
...
import school.prog.hellohei.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "school.prog.hellohei.event1";
    return "school.prog.hellohei.event2";
  }
}
