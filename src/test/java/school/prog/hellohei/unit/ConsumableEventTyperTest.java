package school.prog.hellohei.unit;
...
import school.prog.hellohei.conf.FacadeIT;
...
import school.prog.hellohei.endpoint.event.consumer.model.TypedEvent;
import school.prog.hellohei.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new TypedEvent("school.prog.hellohei.endpoint.event.model.UuidCreated", payload);
